...
#include "third_party/iculehb/src/src/LEScripts.h"
#include "third_party/iculehb/src/src/LELanguages.h"

#include "third_party/icu/icu4c/source/common/unicode/ubidi.h"
#include "third_party/icu/icu4c/source/common/unicode/uchriter.h"
#include "third_party/icu/icu4c/source/common/unicode/brkiter.h"

#if ! UCONFIG_NO_BREAK_ITERATION
#include "third_party/iculx_hb/source/layoutex/LXUtilities.h"
#include "third_party/icu/icu4c/source/common/usc_impl.h" /* this is currently private! */
#include "third_party/icu/icu4c/source/common/cstring.h"  /* this too! */

namespace iculx {

using icu::LayoutEngine;
 ...
 */
static const le_bool complexTable[icu::scriptCodeCount] = {
    FALSE , /* Zyyy */
    FALSE,  /* Qaai */
    TRUE,   /* Arab */
    FALSE,  /* Armn */
...
{
  {"afr", icu::afkLanguageCode}, // Afrikaans
    {"ara", icu::araLanguageCode}, // Arabic
    {"asm", icu::asmLanguageCode}, // Assamese
    {"bel", icu::belLanguageCode}, // Belarussian
    {"ben", icu::benLanguageCode}, // Bengali
    {"bod", icu::tibLanguageCode}, // Tibetan
    {"bul", icu::bgrLanguageCode}, // Bulgarian
    {"cat", icu::catLanguageCode}, // Catalan
    {"ces", icu::csyLanguageCode}, // Czech
    {"che", icu::cheLanguageCode}, // Chechen
    {"cop", icu::copLanguageCode}, // Coptic
    {"cym", icu::welLanguageCode}, // Welsh
    {"dan", icu::danLanguageCode}, // Danish
    {"deu", icu::deuLanguageCode}, // German
    {"dzo", icu::dznLanguageCode}, // Dzongkha
    {"ell", icu::ellLanguageCode}, // Greek
    {"eng", icu::engLanguageCode}, // English
    {"est", icu::etiLanguageCode}, // Estonian
    {"eus", icu::euqLanguageCode}, // Basque
    {"fas", icu::farLanguageCode}, // Farsi
    {"fin", icu::finLanguageCode}, // Finnish
    {"fra", icu::fraLanguageCode}, // French
    {"gle", icu::gaeLanguageCode}, // Irish Gaelic
    {"guj", icu::gujLanguageCode}, // Gujarati
    {"hau", icu::hauLanguageCode}, // Hausa
    {"heb", icu::iwrLanguageCode}, // Hebrew
    {"hin", icu::hinLanguageCode}, // Hindi
    {"hrv", icu::hrvLanguageCode}, // Croatian
    {"hun", icu::hunLanguageCode}, // Hungarian
    {"hye", icu::hyeLanguageCode}, // Armenian
    {"ind", icu::indLanguageCode}, // Indonesian
    {"ita", icu::itaLanguageCode}, // Italian
    {"jpn", icu::janLanguageCode}, // Japanese
    {"kan", icu::kanLanguageCode}, // Kannada
    {"kas", icu::kshLanguageCode}, // Kashmiri
    {"khm", icu::khmLanguageCode}, // Khmer
    {"kok", icu::kokLanguageCode}, // Konkani
    {"kor", icu::korLanguageCode}, // Korean
//  {"mal_XXX", malLanguageCode}, // Malayalam - Traditional
    {"mal", icu::mlrLanguageCode}, // Malayalam - Reformed
    {"mar", icu::marLanguageCode}, // Marathi
    {"mlt", icu::mtsLanguageCode}, // Maltese
    {"mni", icu::mniLanguageCode}, // Manipuri
    {"mon", icu::mngLanguageCode}, // Mongolian
    {"nep", icu::nepLanguageCode}, // Nepali
    {"ori", icu::oriLanguageCode}, // Oriya
    {"pol", icu::plkLanguageCode}, // Polish
    {"por", icu::ptgLanguageCode}, // Portuguese
    {"pus", icu::pasLanguageCode}, // Pashto
    {"ron", icu::romLanguageCode}, // Romanian
    {"rus", icu::rusLanguageCode}, // Russian
    {"san", icu::sanLanguageCode}, // Sanskrit
    {"sin", icu::snhLanguageCode}, // Sinhalese
    {"slk", icu::skyLanguageCode}, // Slovak
    {"snd", icu::sndLanguageCode}, // Sindhi
    {"slv", icu::slvLanguageCode}, // Slovenian
    {"spa", icu::espLanguageCode}, // Spanish
    {"sqi", icu::sqiLanguageCode}, // Albanian
    {"srp", icu::srbLanguageCode}, // Serbian
    {"swe", icu::sveLanguageCode}, // Swedish
    {"syr", icu::syrLanguageCode}, // Syriac
    {"tam", icu::tamLanguageCode}, // Tamil
    {"tel", icu::telLanguageCode}, // Telugu
    {"tha", icu::thaLanguageCode}, // Thai
    {"tur", icu::trkLanguageCode}, // Turkish
    {"urd", icu::urdLanguageCode}, // Urdu
    {"yid", icu::jiiLanguageCode}, // Yiddish
//  {"zhp", icu::zhpLanguageCode}, // Chinese - Phonetic
    {"zho", icu::zhsLanguageCode}, // Chinese
    {"zho_CHN", icu::zhsLanguageCode}, // Chinese - China
    {"zho_HKG", icu::zhsLanguageCode}, // Chinese - Hong Kong
    {"zho_MAC", icu::zhtLanguageCode}, // Chinese - Macao
    {"zho_SGP", icu::zhsLanguageCode}, // Chinese - Singapore
    {"zho_TWN", icu::zhtLanguageCode}  // Chinese - Taiwan
};
...
{
    if (script < 0 || script >= (UScriptCode) icu::scriptCodeCount) {
        return FALSE;
    }
