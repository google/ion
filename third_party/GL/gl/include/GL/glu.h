...
/* We cannot use GLvoid in the parameter type since this is legal in C but not
   in C++. See iterm 18 of C++ Standard Core Language Closed Issues, Revision
   30. (Document number WG21 N1634) */
