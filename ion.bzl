...
def select_build_output_files_for_ion_bazel_platform(
    ...
    return select({
        ...
        "mac_dbg_x86": ["gyp-out/mac-ninja/dbg/" + lib + ".a" for lib in files],
        "mac_opt_x86": ["gyp-out/mac-ninja/opt/" + lib + ".a" for lib in files],
        "mac_dbg_x64": ["gyp-out/mac-ninja/dbg/" + lib + ".a" for lib in files],
        "mac_opt_x64": ["gyp-out/mac-ninja/opt/" + lib + ".a" for lib in files],
