...
#ifndef ION_DEMOS_IOS_SRC_IONGL2VIEW_H_
#define ION_DEMOS_IOS_SRC_IONGL2VIEW_H_
...
@interface IonGL2View : UIView
@property (nonatomic, retain) EAGLContext *context;  // NOLINT
- (void)setFramebufferAsCurrent;
- (BOOL)presentFramebuffer;
@end

#endif  // ION_DEMOS_IOS_SRC_IONGL2VIEW_H_
