...
TEST_F(FakeGraphicsManagerTest, InitialState) {
  ...
  EXPECT_EQ(GL_RGB, GetInt(GL_IMPLEMENTATION_COLOR_READ_FORMAT));
...
TEST_F(FakeGraphicsManagerTest, PlatformCapabilities) {
  ...
  EXPECT_EQ(static_cast<GLenum>(GL_RGB),
  ...
  gm_->SetImplementationColorReadFormat(GL_RGBA4);
  EXPECT_EQ(static_cast<GLenum>(GL_RGBA4),
            gm_->GetImplementationColorReadFormat());
  EXPECT_EQ(GL_RGBA4, GetInt(GL_IMPLEMENTATION_COLOR_READ_FORMAT));
  EXPECT_EQ(GL_RGBA4, gm_->GetConstant<int>(
                          GraphicsManager::kImplementationColorReadFormat));

  gm_->SetImplementationColorReadType(GL_FLOAT);
  EXPECT_EQ(static_cast<GLenum>(GL_FLOAT),
            gm_->GetImplementationColorReadType());
  EXPECT_EQ(GL_FLOAT, GetInt(GL_IMPLEMENTATION_COLOR_READ_TYPE));
  EXPECT_EQ(GL_FLOAT, gm_->GetConstant<int>(
